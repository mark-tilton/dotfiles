...
Caps lock is escape. AeroSpace's mod is the physical opt key — the same position Super occupies on a PC board, so Hyprland bindings can mirror it 1:1. Right-cmd holds a home-row symbol layer.
